...
_C11ATOMIC_NOEXCEPT
{
    if (order != c11atomic_mo_relaxed) {
        _c11atomic_signal_fence_explicit(scope, order);
#if defined(__aarch64__) || defined(_M_ARM64) || defined(_M_ARM64EC) // ARM64
        __dmb(_ARM64_BARRIER_ISH);
        _c11atomic_signal_fence_explicit(scope, order);
#elif defined(__arm__) || defined(_M_ARM) // ARM32
        __dmb(_ARM_BARRIER_ISH);
        _c11atomic_signal_fence_explicit(scope, order);
#elif defined(__x86_64__) || defined(_M_X64) // x86-64
